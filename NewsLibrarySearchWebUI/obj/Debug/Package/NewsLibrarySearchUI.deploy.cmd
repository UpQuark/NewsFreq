...
set _DeploySetParametersFile=%RootPath%NewsLibrarySearchUI.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%NewsLibrarySearchUI.zip" (
echo "%RootPath%NewsLibrarySearchUI.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%NewsLibrarySearchUI.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%NewsLibrarySearchUI.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%NewsLibrarySearchUI.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%NewsLibrarySearchUI.SetParameters.xml" %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%NewsLibrarySearchUI.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%NewsLibrarySearchUI.SetParameters.xml" %_MsDeployAdditionalFlags%
)
goto :eof
...
:usage
echo =========================================================
if not exist "%RootPath%NewsLibrarySearchUI.deploy-readme.txt" (
...
start notepad "%RootPath%NewsLibrarySearchUI.deploy-readme.txt"
)
echo =========================================================
goto :eof
